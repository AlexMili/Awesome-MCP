...
#### Community
- [SkillBoss](https://github.com/heeyo-life/skillboss-mcp) - One API key for 100+ AI services: Claude, GPT, Gemini, DeepSeek, image/video generation, data scraping, payments, email, and more. OpenAI-compatible.
