...
- [Solblade](https://github.com/shillshady/solblade) - AI-native Solana wallet CLI with scoped MCP server for managing wallets with per-wallet permissions, spend limits, and audit logging.
