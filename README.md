...
- [defi-mcp](https://github.com/OzorOwn/defi-mcp) - DeFi & crypto MCP server providing token prices, wallet balances, gas prices, and DEX swap quotes across 7 chains.
