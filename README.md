...
| [sipi.bot](https://github.com/kindrat86/sipi-bot) | Pre-spend firewall for autonomous AI agents — approves, blocks, or flags every transaction before money moves (per-transaction caps, velocity limits, merchant allowlists) in <5ms. MCP server via `python -m spendfirewall.mcp_server`. 53/53 eval, MIT. | <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg" width="18" alt="Python" title="Python"> | 🟢 0d | 6 |
