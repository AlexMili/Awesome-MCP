...
- [CCHub](https://github.com/Moresl/cchub) - Desktop app for managing MCP servers, config profiles, and the Claude Code ecosystem. MCP marketplace, one-click install, health monitoring, security audit.
